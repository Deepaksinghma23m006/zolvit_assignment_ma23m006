...
from haystack.nodes import (AnswerParser, PromptTemplate, EmbeddingRetriever, PromptNode)
...
def setup_prompt():
    return PromptTemplate(prompt=prompt_template, output_parser=AnswerParser())
